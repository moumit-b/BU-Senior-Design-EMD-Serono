#!/usr/bin/env python3
"""
Merck-specific configuration file for Agentic Platform Video Analysis System
...
SYSTEM_CONFIG = {
    ...
    "system_name": "Agentic Platform Video Analysis System",
    "version": "1.0.0",
...
# Scoring configuration aligned with your RFI system
SCORING_CONFIG = {
    "scale": {
        "min": 0,
        "max": 5,
        "descriptions": {
            0: "Not at all - No relevance or completely inappropriate response",
            1: "Partially - Minimal relevance, mostly inappropriate or insufficient",
            2: "Good coverage - Some relevance with significant gaps or limitations", 
            3: "Very good coverage - Strong relevance with minor gaps or limitations",
            4: "Excellent coverage - Comprehensive response with very minor gaps",
            5: "Perfect coverage - Complete, fully appropriate response"
        }
    },
    "criteria": [
