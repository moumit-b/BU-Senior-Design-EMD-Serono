...
def generate_biorxiv_search_url(term=None, title=None, author1=None, author2=None, abstract_title=None, 
    ...
    """Generate bioRxiv search URL based on input fields"""
...
def scrape_biorxiv_results(search_url):
    """Parse article information from bioRxiv search results page, including DOI"""
    headers = {
...
def doi_get_biorxiv_metadata(doi, server="biorxiv"):
    """Fetch detailed metadata for an article via bioRxiv API using DOI"""
